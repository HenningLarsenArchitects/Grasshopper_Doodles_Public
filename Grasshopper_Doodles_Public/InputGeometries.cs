...
{
    /// <summary>
    /// Use this class to input GeometricGoo (all geometry) in a grasshopper component.
    /// Mathias Sønderskov
    /// </summary>
    public static class InputGeometries
    {
        ...
        public static Brep[] UpwardsPointingBrepsFromCurves(IEnumerable<Curve> curves)
        {
            ...
            Brep[] srfs = Brep.CreatePlanarBreps(curves, Units.ConvertFromMeter(0.001));
