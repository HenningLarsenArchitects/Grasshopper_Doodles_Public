...
{
    class InputSelector : IEnumerable<double>
    {
        ...
        public InputSelector(int steps, double? min = null, double? max = null)
        {
            Steps = steps;
        ...
        public InputSelector(List<double> manuallySteps)
        {
            manuallySteps.Sort();
        ...
        public InputSelector(double stepSize, double? min = null, double? max = null)
        {
            StepSize = stepSize;
